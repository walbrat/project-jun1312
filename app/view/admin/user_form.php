    ...
    <div class="w3-card-4 autch">
        ...
        <?php endif; ?>
            ...
            <p>
                ...
                <input name="password_confirm" type="password" value="<?=$password_confirm ?? ''?>" class="w3-input w3-border" >
        ...
        <?php endif; ?>
            ...
            <p>
                ...
                <a href="<?php echo $url_cancel; ?>" class="w3-btn w3-green w3-right"><?=$text_btn_cancel?></a>
            </p>
        </form>
    </div>
</div>